...
$targetUrl = sanitize_url($_POST['targetUrlSpider']);
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Scan Spider</h6>
        </nav>
...
sleep(10);
            ...
            $alerts = json_decode($response, true)['alerts'];
            ...
            $user_id = $_SESSION['id']; // Assurez-vous d'avoir une méthode pour obtenir l'ID de l'utilisateur
            $result = json_encode($alerts);
            $uname = $_SESSION['user_name']; // Assurez-vous que la session est démarrée
